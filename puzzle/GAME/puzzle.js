...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 37648,
    DYNAMIC_BASE = 5280528,
    DYNAMICTOP_PTR = 37632;
...
var wasmBinaryFile = 'puzzle.wasm';
...
var ASM_CONSTS = {
  1119: function($0, $1) {window.localStorage.setItem($0 + "", $1 + "");},  
 1169: function($0) {var data = window.localStorage.getItem($0 + ""); if (data != null) { return data; } else { return 0; }}
};
